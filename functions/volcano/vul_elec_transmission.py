...
#
# Determines the probability of an transmission line being in a given Impact State (IS) or higher:
# * IS0: No damage
...
def function(transmission, multihazard, seed=None):
    ...
    if tephra_hazardValue:
        ...
        if tephra_hazardValue >= 871:
            pIS0 = pIS1 = pIS2 = pIS3 = 1

        elif tephra_hazardValue >= 650:
            pIS0 = pIS1 = pIS2 = 1
            pIS3 = 0.001 * tephra_hazardValue + 0.128

        elif tephra_hazardValue >= 290:
            pIS0 = pIS1 = 1
            pIS2 = 0.001 * tephra_hazardValue + 0.349
            pIS3 = 0.001 * tephra_hazardValue + 0.128

        elif tephra_hazardValue >= 30.5:
            pIS0 = 1
            pIS1 = 0.001 * tephra_hazardValue + 0.71
            pIS2 = 0.001 * tephra_hazardValue + 0.349
            pIS3 = 0.0003 * tephra_hazardValue + 0.039

        elif tephra_hazardValue >= 5:
            pIS0 = 1
            pIS1 = 0.016 * tephra_hazardValue + 0.272
            pIS2 = 0.011 * tephra_hazardValue + 0.046
            pIS3 = 0.001 * tephra_hazardValue + 0.014

        elif tephra_hazardValue > 0.0:
            pIS0 = 0.2 * tephra_hazardValue
            pIS1 = 0.07 * tephra_hazardValue
    ...
    # Summarize the outputs for the given transmission line and hazard scenario
    return {
        'pIS0': pIS0,
        'pIS1': pIS1,
        'pIS2': pIS2,
